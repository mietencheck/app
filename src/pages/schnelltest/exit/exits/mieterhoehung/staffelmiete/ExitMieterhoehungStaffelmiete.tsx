  ...
  return (
    <>
      ...
      <p>
        ...
        Zeitpunkt an zahlen, die im Mietvertrag steht! Dein Vermieter muss dich
        nicht darauf hinweisen. Auch wenn die Staffelmiete zu hoch ist, solltest
        du sie unter Vorbehalt weiterzahlen und dich rechtlich beraten lassen.
      </p>
      <h3>Was nun?</h3>
      <p>
        Um die Rechtmäßigkeit der Miethöhung zu überprüfen, klicke bitte "Neu
        anfangen" unten und wähle dann "Miete für aktuelle oder neue Wohnung" in
        der ersten Frage aus.
      </p>
      <p>
