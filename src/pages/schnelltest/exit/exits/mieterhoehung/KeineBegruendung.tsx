...
export function ExitMieterhoehungKeineBegruendung() {
  ...
  return (
    <>
      <h2>TODO: Die Mieterhöhung ist wahrscheinlich unrechtmäßig.</h2>
      <p>
        ...
        auch ganz kurz sein sollte aber zumindest eins der Wörter „Mietspiegel“
        oder „Vergleichsmiete“ enthalten oder auf ein Tabellenfeld des
        Mietspiegels Bezug nehmen.
      </p>
      <p>
      ...
      <ol>
        ...
        <li>
          ...
          es sein, dass dein Vermieter dich auf die Zustimmung zur Mieterhöhung
          verklagt. Der Vermieter hat dann die Option die Begründung der
          Mieterhöhung vor Gericht nachzuholen und wird dies wahrscheinlich auch
          tun. Dann hast du erneut mindestens einen Monat Zeit um der
          Mieterhöhung zuzustimmen und die Mieterhöhung über diese Website zu
          überprüfen. Wenn du der Mieterhöhung innerhalb der Frist zustimmst
          musst du auch nicht die Prozess- und Anwaltskosten tragen. Dieses
          Vorgehen ist stressiger, dafür musst du aber bis der Vermieter die
          Begründung nachholt, nur die alte Miete bezahlen.
        </li>
      </ol>
